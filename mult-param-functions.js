...
function start() {
  ...
  drawCircle(100, getWidth()/2-100, 25, "purple")
  drawCircle(100, 450, 25, "blue")
  drawSquare(150, 100, 300, "purple")
}
...
function drawSquare(width, xPos, yPos, color){
  ...
  square.style.minHeight = width + "px"
...
rec.style.minWidth = width + "px"
rec.style.minHeight = height + "px"
